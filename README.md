...
- 🎬 **Метаданные (обогащение)**: актёры, режиссёры и внешние ID в карточке «Подробнее» — подключаемые провайдеры (TMDB credits, публичный IMDb-suggestion без ключа, TheTVDB v4).
